...
type LogoProps = { setToggle: (value: boolean) => void };

function Logo({ setToggle }: LogoProps) {
  return (
    <div
    ...
    >
      ...
      >
        <span className="block text-[30px] tracking-[1px]">MR</span>
        <span className="block text-[30px] tracking-[1px]">ND</span>
      </Link>
    </div>
  );
}
