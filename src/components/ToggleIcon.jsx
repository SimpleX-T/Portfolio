function ToggleIcon({ toggle, handleToggle }) {
  return (
    <div
      className="h-[40px] w-[40px] border border-[var(--bg-black-50)] cursor-pointer fixed z-[990] right-[30px] top-[20px] rounded-[5px] bg-[var(--bg-black-100)] flex items-center justify-center"
