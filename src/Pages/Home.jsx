  ...
  return (
    <DisplayCard>
      <div className="container text-[var(--text-black-900)] text-center h-1/2 flex flex-col gap-8">
        <span
          className="inline-block w-36 mx-auto rounded-lg px-2 py-1 text-center capitalize mb-8 bg-[var(--bg-black-100)] text-md font-semibold"
          title={greeting.language}
        >
          {greeting.greeting}
        </span>
        <p className="text-xl font-semibold">I am</p>
        <h1 className="capitalize text-[var(--text-black-900)] leading-none font-extrabold text-5xl md:text-[6rem]">
          Mark{" "}
